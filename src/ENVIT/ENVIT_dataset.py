...
class ENVITDataset(BaselineDataset):
    ...
    def __getitem__(self,idx):
        ...
        audio = F.interpolate(audio.unsqueeze(0), size=(self.args.resolution, self.args.resolution), mode='bilinear', align_corners=False).squeeze(0)
