...
python src/base_trainer.py \
    ...
    --load_ckpt_path "checkpoint/Inceptionv3_Mel_stage1_3loss_50epoch/checkpoint/best.pt" \
    --save_ckpt_path "checkpoint/Inceptionv3_Mel_stage2_10_epoch" \
    --output_dir "checkpoint/Inceptionv3_Mel_stage2_10_epoch/checkpoint" \
    --wandb_run_name "Inceptionv3_Mel_stage2" 
