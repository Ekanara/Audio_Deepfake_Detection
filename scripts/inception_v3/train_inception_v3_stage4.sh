...
python src/base_trainer.py \
    ...
    --load_ckpt_path "checkpoint/Inceptionv3_Mel_stage3_5_epoch/checkpoint/best.pt" \
    --save_ckpt_path "checkpoint/Inceptionv3_Mel_stage4_5_epoch_new" \
    --output_dir "checkpoint/Inceptionv3_Mel_stage4_5_epoch_new/checkpoint" \
    --wandb_run_name "Inceptionv3_Mel_stage4" 
